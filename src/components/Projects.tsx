  ...
  const projects = [
    {
      ...
      description:
        "A comprehensive decentralized finance platform with yield farming, staking, and trading capabilities. Built with React, Solidity, and Web3.js.",
    ...
    },
    {
      ...
      description:
        "Cross-platform mobile application with real-time inventory, payment integration, and push notifications. Serves 50K+ active users.",
      image: "/placeholder.svg?height=300&width=500",
    ...
    },
    {
      ...
      description:
        "Real-time analytics dashboard with machine learning insights, data visualization, and automated reporting features.",
      image: "/placeholder.svg?height=300&width=500",
    ...
    },
    {
      ...
      image: "/placeholder.svg?height=300&width=500",
      technologies: ["Next.js", "Socket.io", "Redis", "AWS", "MongoDB"],
    ...
    },
    {
      ...
      description:
        "Secure and transparent voting system built on blockchain technology with end-to-end encryption and audit trails.",
      image: "/placeholder.svg?height=300&width=500",
      technologies: ["Solidity", "React", "Web3.js", "Node.js", "IPFS"],
      liveUrl: "https://voting-system.com",
      githubUrl: "https://github.com/johndoe/voting-system",
      featured: false,
    },
  ]
      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          {featuredProjects.map((project, index) => (
            <Card
              key={index}
              className="bg-white/5 backdrop-blur-sm border-purple-500/20 hover:border-purple-500/40 transition-all duration-300 overflow-hidden group"
            >
        ...
        {/* Other Projects */}
        <div className="mb-8">
          <h3 className="text-2xl font-bold text-white text-center mb-8">Other Notable Projects</h3>
              ...
              >
                ...
                <CardContent className="p-4">
                  ...
                  <div className="flex gap-2">
                    <Button
                      size="sm"
                      className="bg-gradient-to-r from-purple-500 to-cyan-500 hover:from-purple-600 hover:to-cyan-600 text-white text-xs px-3 py-1"
                      onClick={() => window.open(project.liveUrl, "_blank")}
                    >
